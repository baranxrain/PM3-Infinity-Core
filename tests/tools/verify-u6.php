...
$pass(ProcessMaker\Util\LegacyUtf8::encode("Error en la l\xEDnea 3") === utf8_encode("Error en la l\xEDnea 3"), 'A latin-1 trigger error message encodes identically');
