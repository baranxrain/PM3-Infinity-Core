...
include_once 'classes/model/OauthAccessTokensPeer.php';

/**
 * Base class that represents a row from the 'OAUTH_ACCESS_TOKENS' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseOauthAccessTokens extends BaseObject implements Persistent
{
