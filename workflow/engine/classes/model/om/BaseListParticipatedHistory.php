...
include_once 'classes/model/ListParticipatedHistoryPeer.php';

/**
 * Base class that represents a row from the 'LIST_PARTICIPATED_HISTORY' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseListParticipatedHistory extends BaseObject implements Persistent
{
     ...
     * @var        ListParticipatedHistoryPeer
    */
