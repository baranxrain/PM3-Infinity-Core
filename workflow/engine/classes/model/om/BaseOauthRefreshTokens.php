...
include_once 'classes/model/OauthRefreshTokensPeer.php';

/**
 * Base class that represents a row from the 'OAUTH_REFRESH_TOKENS' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseOauthRefreshTokens extends BaseObject implements Persistent
{
