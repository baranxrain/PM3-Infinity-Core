...
/**
 * Preserves the byte-level ISO-8859-1/UTF-8 conversion contract used by the
 * legacy engine without depending on extensions or mutable global settings.
 */
final class LegacyUtf8
{
